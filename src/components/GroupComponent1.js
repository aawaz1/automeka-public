const GroupComponent1 = () => {
  return (
    <div className="self-stretch bg-darkorange flex flex-row items-start justify-between pt-[91px] px-[277px] pb-[83px] shrink-0 [debug_commit:f6aba90] text-left text-17xl text-white font-poppins mq1300:pl-[138px] mq1300:pr-[138px] mq1300:box-border mq1650:flex-wrap mq1650:justify-center mq900:pl-[69px] mq900:pr-[69px] mq900:box-border">
      ...
      <div className="flex flex-col items-start justify-start pt-px px-0 pb-0 box-border max-w-full">
        <h1 className="m-0 relative text-inherit font-bold font-inherit z-[1] mq450:text-3xl mq900:text-10xl">
          Subscribe Our Newsletter
        </h1>
      </div>
      <div className="w-[615px] rounded bg-white box-border flex flex-row items-start justify-start py-0 pr-px pl-[11px] gap-[205px] max-w-full z-[1] text-center text-lg text-dimgray-200 border-[1.8px] border-solid border-white mq450:gap-[205px_51px] mq900:flex-wrap mq900:gap-[205px_102px]">
